...
## Checking for confounders: Electricity Demand
...
### Check II: Comparing with 2020-2021 Nightlights data 
...
# ---------------------------
cuts=c(0,1,2,5,10,20,50,100,500,65535)
levelplot(rjan21, at=cuts, par.settings=rasterTheme(ntlcol),
          sub=expression(Watt/cm2/sr), margin=F, maxpixels = 1e6)

levelplot(rmay21, at=cuts, par.settings=rasterTheme(ntlcol),
          sub=expression(Watt/cm2/sr), margin=F, maxpixels = 1e6)
```
