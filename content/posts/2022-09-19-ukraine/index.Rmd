...
mapView(rjan, col.regions = ntlcol, at=cuts, maxpixels=1e6, alpha.regions = 0.9, zoom=6)


levelplot(rmay, at=cuts, par.settings=rasterTheme(ntlcol),main='May 2022',
          sub=expression(Watt/cm2/sr),pretty=T,maxpixels = 1e6, margin=F)
mapView(rmay, col.regions = ntlcol, at=cuts, maxpixels=1e6, alpha.regions = 0.9,zoom=6)
...
Drop in nightlightslights across months
