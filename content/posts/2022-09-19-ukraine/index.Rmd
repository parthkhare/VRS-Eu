...
leaflet() %>% addTiles() %>%
  ...
  addRasterImage(rjan, at=cuts2, colors = ntlcol, opacity = 0.9, group="Jan-2022") %>%
  addRasterImage(rfeb, at=cuts2, colors = ntlcol, opacity = 0.9, group="Feb-2022") %>%
  addRasterImage(rmar, at=cuts2, colors = ntlcol, opacity = 0.9, group="Mar-2022") %>%
  addRasterImage(rapr, at=cuts2, colors = ntlcol, opacity = 0.9, group="Apr-2022") %>%
  addRasterImage(rmay, at=cuts2, colors = ntlcol, opacity = 0.9, group="May-2022") %>%
