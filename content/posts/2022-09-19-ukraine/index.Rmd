...
ntlcol <- c("#09090c", "#19192f",'#0000a6' ,"#ffb300",'#FFC300','#FFED18', "#ffe200")
# cuts
...
#### Changes across the months

![](UkrNtl_lres.gif)

<!-- ```{r message=F,echo=F,warning=FALSE} -->
<!-- mntit <- c("NTL_Feb22","NTL_Mat22","NTL_Apr22","NTL_May22","NTL_Jun22") -->

<!-- s <- stack(x=c(rjan, rfeb, rmar, rapr, rmay)) -->

<!-- # raster animation save gif -->
<!-- saveGIF({ -->
<!--   for(i in c(1:nlayers(s))) -->
<!--   { -->
<!--     l <- levelplot(s[[i]], at=cuts,par.settings=rasterTheme(ntlcol),maxpixels = 1e5, -->
<!--                    margin=FALSE, main=mntit[i], sub=expression(Watt/cm2/sr))  -->
<!--     # l <- levelplot(s[[i]], par.settings=rasterTheme(ntlcol),margin=FALSE, main=mntit[i]) -->
<!--     plot(l) -->
<!--   } -->
<!-- }, interval=2, movie.name="UkrNtl_lres.gif") -->
