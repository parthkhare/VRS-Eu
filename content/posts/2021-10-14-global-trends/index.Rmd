...
```{r, echo=FALSE, error=FALSE, fig.cap="A caption", out.width = '100%'}
...
knitr::include_graphics("themes/hugo-eureka/assets/images/GNcharts/IMF_WEO_NL.png")
```

## Long difference: Quarters
![s](themes/hugo-eureka/assets/images/GNcharts/Longdiff_quar.png)

```{r, echo=FALSE, error=F, fig.cap="A caption", out.width = '100%'}
...
knitr::include_graphics("themes/hugo-eureka/assets/images/GNcharts/Longdiff_quar.png")
```
