...
for(i in 1: length(cats))
{
  ...
  cp <- ggplot(dts, x=aes(log(sum_pix), y=log(nom_gdp))) + geom_point() +
...
print(multiplot(plotlist = plot_corr, cols = 4))
...
## Long difference: HWS style


## Quarter wise correlations: IMF GDP
