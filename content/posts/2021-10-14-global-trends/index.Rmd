...
knitr::include_graphics("themes/hugo-eureka/assets/images/GNcharts/IMF_WEO_NL.png",error=FALSE)
```

## Long difference: Quarters
![](themes/hugo-eureka/assets/images/GNcharts/Longdiff_quar.png)
...
knitr::include_graphics("themes/hugo-eureka/assets/images/GNcharts/Longdiff_quar.png",error=F)
```
